...
namespace WindowsFormsApplication1
{
    ...
    {
        DatabaseEntities simbirSoft2;
       
        public Main()
        {
            simbirSoft2 = new DatabaseEntities();
            InitializeComponent();
        }
        ...
        public void addToBd()
        {
            ...
            try
            {
                max = simbirSoft2.Hystory.Max(c => c.Id);
            }
            catch
            {
                max = 0;
            ...
            hystory.Player1 = textBox1.Text;
            hystory.Player2 = textBox2.Text;
            hystory.KolvoHod = xod + 1;
            hystory.Win = player;
            simbirSoft2.Hystory.Add(hystory);
            try
            {
                simbirSoft2.SaveChanges();
            }
            catch (Exception ex)
            {
                MessageBox.Show("Не удалось сохранить игру: " + ex);
            }
        }
